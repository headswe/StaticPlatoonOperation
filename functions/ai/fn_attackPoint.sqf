...
_wp = [_grp, _location, 0, "MOVE", "AWARE", "RED", "FULL", "WEDGE","", [0,0,0], 200] call CBA_fnc_addWaypoint;
_wp = [_grp, _location, 0, "SAD", "AWARE", "RED", "FULL", "WEDGE","", [0,0,0], 200] call CBA_fnc_addWaypoint;