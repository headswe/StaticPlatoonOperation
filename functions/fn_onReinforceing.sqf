...
_grp setVariable ["dsm_reinforcement_location", getPosATL leader _groupToReinforce];
...
_wp setWaypointStatements ["true", "(this) setVariable ['dsm_reinforceing', grpNull]"];
